(function ($) {
    ...
    var qzFunc = {
        ...
        createAllTopic: function (dt) {
            var topicDom = '';
            topicDom += '<li data-topicid="' + dt.Id + '" data-topic="' + dt.Title + '">';
            topicDom += '<a href="' + commonApiUrl + 'm/topic/' + dt.Id + '"><b>' + dt.Title + '</b><span><i class="num-in">0</i>人参与<i class="num-comm">0</i>条主题</span></a>';
            topicDom += '</li>';
            return topicDom;
        },
        //插入全部话题列表
